...
export class AddBug extends Component
{
    ...
    saveProject = () => {
        ...
        if (isValid)
        {
            ...
            axios.post(config.serverUrl + "/api/bug/save", bug).then(response=> {
                                       ...
                                       <div id="tester" class="form-group">
                                        ...
                                        <div class="tab-pane" id="tab_2">
                                            ...
                                            <div class="form-horizontal">
                                                ...
                                                <div class="col-md-7 col-sm-12">
                                                    <textarea id="editor1" class="form-control" name="description" onChange={this.onValueChange}></textarea>
                                                </div>
                                                </div>
                                            </div>         
                                        </div>
